...
const fields = [
    ...
    { id: 'edad', label: 'Fecha de Nacimiento' },
        ...
        switch (id) {
            ...
            case 'email':
                ...
                if (!regexEmail.test(value)) {
                    valid = false;
                    message = 'Ingrese un email válido. (solo se aceptan correos de UCASAL)';
                } 
                break;
            case 'edad': {
                // Convertimos el valor en Date para calcular la edad exacta.
                ...
                if (!(fechaNacimiento instanceof Date) || isNaN(fechaNacimiento.getTime())) {
                    ...
                    const monthDiff = fechaActual.getMonth() - fechaNacimiento.getMonth();
                    const dayDiff = fechaActual.getDate() - fechaNacimiento.getDate();
                    if (monthDiff < 0 || (monthDiff === 0 && dayDiff < 0)) {
                        age -= 1;
                    }
                    if (age < 18 || age > 40) {
                        valid = false;
                        message = 'Debes tener más de 18 años y menos de 40 años.';
                    }
                }
                break;
            }
